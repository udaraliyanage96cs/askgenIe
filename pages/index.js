...
export default function Home() {
  ...
  return (
    <div className={`${styles.wrap} ${mode == 'day' ? styles.day : styles.night}`}>
      ...
      <div className={`${styles.main} ${(!loading || searchLoading ) ? styles.fexlstart : ''}`}>
        <Head>
          <title>OpenAI - Ask genIe</title>
        </Head>
        <div className={styles.mainContainer}>
          <main >
            {loading && !searchLoading && (
              <form onSubmit={onSubmit}>
                <h3 className={`${styles.title} ${lobster.className}`}>Ask genIe</h3>
                ...
                <div className={`${styles.tagline} ${inter.className}`}>Tired of browsing?Ask genIe</div>
              </form>
            )}
            {(!loading || searchLoading )&& (
              <form onSubmit={onSubmit}>
                <div className={`row ${styles.position_relative}`}>
                  <div className="col-lg-4"><h3 className={`${styles.title} ${lobster.className}`}>Ask genIe</h3></div>
